...
public class ClassNameFactory implements ModelFactory, DocumentAware, Iterable<String> {
    ...
    static private class AliasNameFactoryModelProvider implements BeanContainer {
        private BeanContainer modelProvider;
        private Document document;

        public AliasNameFactoryModelProvider(BeanContainer modelProvider, Document document) {
