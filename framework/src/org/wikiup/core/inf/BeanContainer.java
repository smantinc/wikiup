...
public interface BeanContainer {
    /**
     * BeanContainer was inspired by <a href="http://picocontainer.codehaus.org/">PicoContainer</a>,
     * which is an Inversion of Control (IoC) container for components honor the Dependency Injection pattern.
     * <p/>
     * The basic idea is, BeanContainer is a container from which we can query an instance by its class type,
